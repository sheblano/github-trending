...
**This project was vibe-coded with my technical direction and architectural guidance.** Every feature, data model, and UX decision was deliberately shaped — the AI pair-programming just made it faster to ship.
